...
function initTextures(){
  //initTexture( app.models.airplane, "models/diff.jpg" );
}
...
function initCurve(){
  ...
  app.curve.curve = new Bezier(-1.5,0,1.5 , 1.5,0,3 , 3,0,-3 , -1.5,0,-1.5);
  app.curve.startPoint = [-1.5, 0, 1.5];
  app.curve.endPoint = [3,0,-3];
  app.curve.controlPoint1 = [1.5,0,3];
  app.curve.controlPoint2 = [-1.5,0,-1.5];
  app.updateCurve = updateCurve;
  app.updateCurve();
}

function updateCurve(){
  app.curve.curve = new Bezier(
    app.curve.startPoint[0], app.curve.startPoint[1], app.curve.startPoint[2],
    app.curve.controlPoint1[0], app.curve.controlPoint1[1], app.curve.controlPoint1[2],
    app.curve.controlPoint2[0], app.curve.controlPoint2[1], app.curve.controlPoint2[2],
    app.curve.endPoint[0], app.curve.endPoint[1], app.curve.endPoint[2]);
  app.curve.length = app.curve.curve.length();
}
